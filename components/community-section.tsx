      ...
      <div className="site-container relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="space-y-4">
              <Button 
                className="w-full justify-start bg-card hover:bg-card/80 border border-border/50 hover:border-primary/50 transition-all"
                variant="outline"
              ...
              <Button 
                ...
                variant="outline"
                onClick={() => window.open("https://github.com/Samanyu-dev/Aether/issues", "_blank")}
              >
